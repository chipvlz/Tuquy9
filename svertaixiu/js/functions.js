jQuery(function ($) {
	...
	chenthoigian(-9999);
	try{
		socket_taixiu = io.connect('http://115.84.183.203:9094');//('http://115.84.183.203:9094');//('http://103.15.50.106:9094');
...
//						console.log(ob[0]);
						if (w != '') {
							var pr = '<li id="' + ob[0].gameId + '" onClick="openHistoryTaixiu(\''+ ob[0].gameId +'\', \'' + ob[0].winner + '\', \''+ ob[0].detail_dice +'\')" class="' + w + '" title="' + title + '">' +
