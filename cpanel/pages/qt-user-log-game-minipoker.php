    ...
    <form id="validate" class="main" method="post" action="">
     <fieldset>
      <div class="widget">
       ...
       <div class="formRow">
        ...
        <div class="grid9">
         <select name="gameid" id="selectReq" class="validate[required]" >
          <option value="minipoker" selected="selected">Mini Poker</option>
         </select>
        </div>
        <div class="clear"></div>
       </div>
       ...
       <div class="formRow">
        <button type="button" value="Thực hiện" class="buttonM bBlack formSubmit" id="cmdExeHisMiniPoker">Thực hiện</button>
        <div class="clear"></div>
       </div>
       <div class="clear"></div>
      </div>
...
<!--
$('#cmdExeHisMiniPoker').click(function(event) {
