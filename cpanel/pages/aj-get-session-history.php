...
<div class="whead"><h6>Lịch sử ván đánh game <?php echo $gameName?></h6><div class="clear"></div></div>
    ...
    <?php 
        $sql = "SELECT bonushistory.username, bonushistory.tien_cuoc, bonushistory.tien_thuong, bonushistory.tien_tra_lai, bonushistory.loai, bonushistory.gameid,bethistory.betmoney, bethistory.bettype, bethistory.time
                from bonushistory 
                join bethistory on bonushistory.username=bethistory.username and bonushistory.gameid=bethistory.gameid
